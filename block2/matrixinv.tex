...
\edXsolution{ $f(x)$ and $g(y)$ are inverse functions. We see above that $f(x)$ evaluated at -13 has an output of -2197. Since $g(y)$ and $f(x)$ perform opposite actions, we know that g evaluated at -2197 has an output of -13.
}
