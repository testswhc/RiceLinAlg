...
\beginedxtext{Definition of Linearly Independent and Dependent}
...
\beginedxvertical{Proving Linear Independence}

\beginedxproblem{Proving Linear Independence}{\dpa3}

Before we start in on the proposition, let's think about the definition of linear independence.  
