...
\edXsolution{ $v+w = \left[\begin{array}{c} 2+1 \\ 3+(-1)  \\ 4+0 \end{array} \right]=\left[\begin{array}{c} 3 \\ 2  \\ 4 \end{array} \right]$\\
...
\edXsolution{The vector $w$ has 4 integer valued entries.  Thus, it is a element of a four dimensional vector space over a field that contains the integers.}
...
\edXsolution{False.  For example, we can consider the complex numbers as a one dimensional vector space over \R.  First, the complex nubmers are closed under addition and multiplication by a real number.  Additive and multiplicative properties of the complex numbers ensure that conditions 1-4 are satisfied.  Also, since \R is a subset of the complex numbers, properties of the complex numbers also ensure that conditions 5-7 are satisfied.}
